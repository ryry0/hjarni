...
# Need to disable this because Eigen redefines new as well
# This causes compilation issues because you can't have redefinition
...
ifndef CPPUTEST_WARNINGFLAGS
	CPPUTEST_WARNINGFLAGS =  -Wall -Wextra -Wshadow -Wswitch-default -Wswitch-enum -Wconversion -Wno-long-long #-Werror commented out so I can use anonymous structs
ifeq ($(CPPUTEST_PEDANTIC_ERRORS), Y)
	CPPUTEST_WARNINGFLAGS += -pedantic #-pedantic-errors commented out so I can use anonymous structs
endif
